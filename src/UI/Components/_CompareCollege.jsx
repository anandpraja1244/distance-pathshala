...
import ReadMore from "../../assets/images/compair/ReadMore.svg";
			...
			<div className="container-fluid compareCollege">
				<div className="container">
					...
					<div className="compareCollege-section compareCollege-section-footer">
						...
						<div className="compareCollege-section__body">
							<div className="compareCollege-section__body-item compareCollege-section__body-item1" style={{border:0}}>
								<div className="compareCollege-section__btns " id="ani" style={{border:0}}>
									{props.college1?.uid ? (
										<>
											...
											<img src={ApplyNowButtoncompair} className="img-fluid" alt="" />
											</Link>
										</>
									) : (
										<></>
							...
							<div className="compareCollege-section__body-item " style={{border:0}}>
