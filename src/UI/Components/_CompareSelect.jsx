...
import EST from "../../assets/images/compair/est.svg";
import Fee from "../../assets/images/compair/fee.svg";
import Verifyc from "../../assets/images/compair/verifyc.svg";
import ApplyNowButtoncompair from "../../assets/images/compair/ApplyNowButtoncompair.svg";
...
export default function CompareSelect() {
        ...
        <div className="container-fluid">
          <div className="container">
            <div className="compareSelect__title">
              <p>
                {compareCollegeArr.length > 0 ? "" : "No College is Selected"}{" "}
              </p>
            </div>
            <div className="compareSelect__boxs">
              <div className="row">
                <div className="col-lg-4 col-md-4 col-sm-6 col-12">
                  {CompareSelectBox(college1, 1)}
                </div>
                <div className="col-lg-4 col-md-4 col-sm-6 col-12">
                  {CompareSelectBox(college2, 2)}
                </div>
                <div className="col-lg-4 col-md-4 col-sm-6 col-12">
                  {CompareSelectBox(college3, 3)}
                </div>
            ...
            <div className="compareSelect__footer d-none">
              ...
              <div
                className="compareSelect__startBox"
                style={{ display: isHiddenStart ? "none" : "block" }}
              >
  ...
  function CompareSelectBox(colObj, collegeCount) {
    return (
      <>
        {/* <div className="collagebox p-3 text-center">
		<button
              className="compareSelectBox__removeBtn"
              onClick={(e) => removeFromCompare(colObj.uid)}
            >
              X
            </button>
          <div className="collageimage">
            <img
              src={colObj.uid ? img_ignou : icon_plus}
              className="img-fluid"
              alt=""
            />
			<hr></hr>
          ...
          <div
            ...
            <h1 className="p-3">
              ...
              NAAC Accreditation {colObj.naacrating}, {colObj.naaccgpa} (CGPA)
            </h1>
          </div>
          <div className="d-flex justify-content-center">
            <div className="d-flex borderright">
              
              <img src={EST} className="img-fluid" alt="" /> &nbsp;
              <p className="f-700">ESTD. 1968</p>
            </div>
            <div className="">
              <p className="f-700">New Delhi (30 CITY & STATE)</p>
            </div>
          </div>
          ...
          <div className="d-flex  mt-2 justify-content-center">
            <div className="d-flex borderright">
              ...
              <img src={Verifyc} className="img-fluid" alt="" /> &nbsp;
              <p className="f-700">Approved By</p>
            </div>
            <div className="">
              <p className="f-700">New Delhi (30 CITY & STATE)</p>
          ...
          <div className="d-flex  mt-2 justify-content-center">
            <div className="d-flex borderright">
              ...
              <img src={Fee} className="img-fluid" alt="" /> &nbsp;{" "}
              <p className="f-700">Fee</p>
            </div>
            <div className="">
              <p className="f-700">New Delhi (30 CITY & STATE)</p>
            </div>
          </div>
		  <button className="style-none compairbuttonn mt-2 pt-3"><img src={ApplyNowButtoncompair} className="img-fluid" alt="" /></button>
        </div>
<br/>
<br/> */}
        <div className="compareSelectBox">
          ...
          <div className="compareSelectBox__mid">
            <div className="compareSelectBox__circle">
              <a
                className="compareSelectBox__circleBtn"
                href={
                  colObj.uid
                    ? "/College/detail/" + colObj.uid
                    : URLMapping.findCourse.label
                }
              >
          ...
          <div className="compareSelectBox__low">
            {colObj.uid ? (
              <div className="compareSelectBox__Text">
                <p>
                  NAAC Accreditation <br /> {colObj.naacrating},{" "}
                  {colObj.naaccgpa} (CGPA)
                </p>
              </div>
            ) : (
    ...
    <div className="compareSelectBox">
      <div className="compareSelectBox__addBtnBox">
        <input
          type="checkbox"
          checked={isInCompare}
          onChange={(e) => addToCompare(colObj)}
        />
      </div>
      <div className="compareSelectBox__top">
        <p>{colObj.name}</p>
      ...
      <div className="compareSelectBox__low">
        {colObj.uid ? (
          <div className="compareSelectBox__Text">
            <p>
              NAAC Accreditation <br /> {colObj.naacrating}, {colObj.naaccgpa}{" "}
              (CGPA)
            </p>
          </div>
        ) : (
