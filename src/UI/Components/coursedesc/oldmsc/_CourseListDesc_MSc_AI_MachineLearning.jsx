  ...
  return (
    <>
      <Helmet>
        ...
        />
        <meta name="keywords" content="Artificial Intelligence Distance learning" />
      </Helmet>
      <div className="container-fluid courseListDesc">
        <div className="container">
          <div className="section">
            <h3>Online M. Sc Artificial intelligence and machine learning</h3>
            <p>
              Artificial intelligence and machine learning is a master's degree
              program that offers knowledge in machine learning and AI.
              Aspirants will gain various knowledge of AL along with the
              knowledge of CS to make a career in the computing industry. This
              course also focuses on the studies of computing exclusively. In
              this course, students will learn cognitive engineering tactics in
              machine learning and AI with the knowledge of computer networks.
            </p>
          </div>
          <div className="section">
            <h3>
          ...
          <div className="section">
            ...
            <div className="section-sub">
              ...
              <ul>
                ...
                <li>
                  Computer Vision Fundamentals and Deep Learning Applications -1
                </li>
              ...
              <ul>
                <li>
                  Computer Vision Fundamentals and deep learning fundamentals -
                  2{" "}
                </li>
                <li>
