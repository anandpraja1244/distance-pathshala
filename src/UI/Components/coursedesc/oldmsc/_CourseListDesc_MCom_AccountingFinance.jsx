      ...
      <div className="container-fluid courseListDesc">
        <div className="container">
          <div className="section">
            <h3>Online and distance M.com Accounting and Finance </h3>
            <p>
          ...
          <div className="section">
            ...
            <ul>
              <li>Accountant analyst</li>
              <li>Risk managers</li>
              <li>Finance executive</li>
              <li>Other managerial roles</li>
            </ul>
          </div>
          <div className="section">
            <h3>
              Top hiring firms for online and distance M.com in accounting and
              finance
            </h3>
            <p>
