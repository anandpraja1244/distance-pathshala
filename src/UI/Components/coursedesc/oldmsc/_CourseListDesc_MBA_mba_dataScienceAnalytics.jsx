...
export default function CourseListDesc() {
  return (
    <>
      <Helmet>
      <title>
        Online & Distance MBA In Data Science And Analytics Management colleges in India | Distance Pathshala
        </title>
        <meta
          name="description"
          content="Get the Best Online and Distance MBA in Data Science And Analytics Management distance learning colleges/University in India. Distance Pathshala is Best option to advance your career."
        />
        <meta name="keywords" content="MBA In Data Science And Analytics Management colleges" />
      </Helmet>
      <Searchform />
      ...
      <div className="container-fluid courseListDesc">
        <div className="container">
          <div className="section">
            <h3>Online and distance M. Sc in applied finance</h3>
            <p>
              This is the field of education in business-related models with a
              qualified structure of applications and methods. M. Sc in applied
              finance is one of the most popular courses that help in solving
              and identifying various issues in finances. This program imparts a
              vast knowledge of investment management. M. Sc in applied finances
              course will teach various skills that are required to meet the
          ...
          <table className="section-table section table">
            ...
            <tbody>
              <tr>
                <td>B.Tech / B. Sc / B. Sc pass out </td>
          ...
          <div className="section">
            <h3>
              Here is a common procedure to take admission in the distance M. Sc
              in Applied finance
            </h3>
            <ul>
              <li>
          ...
          <div className="section">
            ...
            <ul>
              ...
              <li>Equity Analysis and Evaluation</li>
              <li>Economics for Evaluation</li>
