      ...
      <div className="container-fluid courseListDesc">
        <div className="container">
          <div className="section">
            <h3>
              Online and distance M.com in professional accounting and finance
            </h3>
            <p>
              M.com in professional accounting and finance completely focus on
              financial and accounting aspects. The course prepares the students
              for entry and middle-level positions. Aspirants will learn the
              necessities of financial and accounting surveys, financial
              advisory, financial management, and a lot more stuff in this M.com
              course. This online and distance M.com in professional accounting
              and finance course will help in building strong finance and
              accounting knowledge.
            </p>
          </div>
          <div className="section">
            <h3>
              WWhy should you choose M.com in professional accounting and
              finance?
            </h3>
            <p>
          ...
          <div className="section">
            <h3>
              Here is a common procedure to take admission in the distance M.com
