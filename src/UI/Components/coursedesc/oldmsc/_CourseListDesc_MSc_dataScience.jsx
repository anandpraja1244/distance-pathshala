...
export default function CourseListDesc() {
  return (
    <>
      <Helmet>
        <title>
		MSc Distance Machine Learning and Data Science in India
        </title>
        <meta
          name="description"
      ...
      <div className="container-fluid courseListDesc">
        <div className="container">
          <div className="section">
            <h3>Online and distance M. Sc data science </h3>
            <p>
          ...
          <div className="section">
            ...
            <p>
              Many top companies are hiring M. Sc in data science with good pay.
              Aspirants who completed this course can apply for the
