...
export default function CourseListDesc() {
  return (
    <>
      ...
      <Searchform />
      <img src={Hr_management} alt="M.Tech in General " className="w-100" /> 
      ...
      <div className="container-fluid courseListDesc">
        <div className="container">
          ...
          <div className="section">
            <h3>
            Why should you choose Online MCA in Machine Learning & Artificial Intelligence?
            </h3>
          ...
          <img src={elegibilty} alt="admin" className="w-100 mt-5" />
           <div className="container py-3 text-center">
            <p>Here is a common procedure to take admission in the distance MCA in  <br></br>Cyber Machine Learning in Artificial Intelligence</p>
      ...
      <div className="container faq">
        ...
        <Accordion defaultActiveKey="0" className="mt-3">
          <Accordion.Item eventKey="0">
            <Accordion.Header>
              <h5>Is MCA in Machine Learning and Artificial Intelligence suitable for the future?</h5>
            </Accordion.Header>
            <Accordion.Body>
         <p>Artificial Intelligence is taking over every aspect of businesses today, and students taking up this course can benefit greatly through the course. With the profession high in demand, students can get jobs in top companies in India and set their careers for good.</p>
            </Accordion.Body>
          </Accordion.Item>
          <Accordion.Item eventKey="1" className="mt-2">
            ...
            <Accordion.Body>
  <p>JEE Main, JEE Advanced, GATE, CMAT, and MAT are some of the entrance exams. Some universities do not require entrance exams at all. These are examinations administered by individual institutes at the state and national levels. It depends on the institute whether an entrance exam is required.</p>
            </Accordion.Body>
          </Accordion.Item>
          ...
          <Accordion.Item eventKey="2" className="mt-2">
            <Accordion.Header>
              <h5>
              How much does MCA in Machine Learning and Artificial Intelligence cost?</h5>
            </Accordion.Header>
            <Accordion.Body>
              <p>
          ...
          <Accordion.Item eventKey="3" className="mt-2">
            <Accordion.Header>
              <h5>
              What are the career options for graduates of the Online MCA in Machine Learning and Artificial Intelligence program?</h5>
            </Accordion.Header>
            <Accordion.Body>
              <p>
