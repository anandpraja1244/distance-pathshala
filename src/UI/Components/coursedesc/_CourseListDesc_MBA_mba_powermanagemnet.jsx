...
export default function CourseListDesc() {
  return (
    <>
      <Helmet>
      <title>
        Online & Distance MBA In Power Management colleges in India | Distance Pathshala


        </title>
        <meta
          name="description"
          content="Get the Best Online and Distance MBA in Power Management distance learning colleges/University in India. Distance Pathshala is Best option to advance your career."
        />
        <meta name="keywords" 
        content="MBA In  Power Management  colleges" />
      </Helmet>
      {/* <h1>power managemnet</h1>
      <h1>multimedia not</h1> */}

      <Searchform />
      <img src={Mr_management} alt="MBA In  Power Management  colleges" className="w-100" />
