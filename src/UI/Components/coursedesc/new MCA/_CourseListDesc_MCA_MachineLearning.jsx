        ...
        <div className="container">
            ...
            <div className="container p-0">
              <div className="row">
                <div className="col-md-6">
                  <p className="Semester-left">Quarter 1</p>
                ...
                <div className="col-md-6">
                  <p className="Semester-right">Quarter 2</p>
                  <ul className="p-0 mt-1">
          ...
          <div className="section mt-1" id="Semester">
            <div className="container p-0">
              <div className="row">
                <div className="col-md-6">
                  <p className="Semester-left sam-back">Quarter 3</p>
                  <ul className="p-0 mt-1">
                ...
                <div className="col-md-6">
                  <p className="Semester-right sam-back2">Quarter 4</p>
                  <ul className="p-0 mt-1">
